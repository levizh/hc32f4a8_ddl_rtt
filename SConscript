...
src = Split('''
cmsis/Device/HDSC/hc32f4xx/Source/system_hc32f4a8.c
...
hc32_ll_driver/src/hc32f4a8_ll_interrupts_share.c
''')
...
if rtconfig.PLATFORM in ['gcc']:
    start_src += [cwd + '/cmsis/Device/HDSC/hc32f4xx/Source/GCC/startup_hc32f4a8.S']
elif rtconfig.PLATFORM in ['armcc', 'armclang']:
    start_src += [cwd + '/cmsis/Device/HDSC/hc32f4xx/Source/ARM/startup_hc32f4a8.s']
elif rtconfig.PLATFORM in ['iccarm']:
    start_src += [cwd + '/cmsis/Device/HDSC/hc32f4xx/Source/IAR/startup_hc32f4a8.s']
